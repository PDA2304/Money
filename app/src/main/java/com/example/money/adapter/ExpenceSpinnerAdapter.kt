...
class ExpenceSpinnerAdapter(context: Context) : ArrayAdapter<ItemExpenceSpinner>(context, 0, ItemExpenceSpinner.values()) {
    ...
    fun setItem(view: View, model: ItemExpenceSpinner) {
